...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cache_context.pager' => 'getCacheContext_PagerService',
            ...
            'image.page_cache_response_policy.deny_private_image_style_download' => 'getImage_PageCacheResponsePolicy_DenyPrivateImageStyleDownloadService',
            ...
            'node.page_cache_response_policy.deny_node_preview' => 'getNode_PageCacheResponsePolicy_DenyNodePreviewService',
            ...
            'test_discovery' => 'getTestDiscoveryService',
    ...
    /**
     * Gets the 'cache_context.pager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\Core\Cache\PagerCacheContext A Drupal\Core\Cache\PagerCacheContext instance.
     */
    protected function getCacheContext_PagerService()
    {
        $this->services['cache_context.pager'] = $instance = new \Drupal\Core\Cache\PagerCacheContext($this->get('request_stack'));

        $instance->_serviceId = 'cache_context.pager';
    ...
    {
        $this->services['cache_contexts'] = $instance = new \Drupal\Core\Cache\CacheContexts($this, array(0 => 'url', 1 => 'pager', 2 => 'language', 3 => 'theme', 4 => 'timezone', 5 => 'menu.active_trail', 6 => 'node_view_grants', 7 => 'user', 8 => 'user.roles'));
    ...
    /**
     * Gets the 'image.page_cache_response_policy.deny_private_image_style_download' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getImage_PageCacheResponsePolicy_DenyPrivateImageStyleDownloadService()
    {
        $this->services['image.page_cache_response_policy.deny_private_image_style_download'] = $instance = new \Drupal\image\PageCache\DenyPrivateImageStyleDownload($this->get('current_route_match'));

        $instance->_serviceId = 'image.page_cache_response_policy.deny_private_image_style_download';
    ...
    /**
     * Gets the 'node.page_cache_response_policy.deny_node_preview' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getNode_PageCacheResponsePolicy_DenyNodePreviewService()
    {
        $this->services['node.page_cache_response_policy.deny_node_preview'] = $instance = new \Drupal\node\PageCache\DenyNodePreview($this->get('current_route_match'));

        $instance->_serviceId = 'node.page_cache_response_policy.deny_node_preview';
    ...
    public function getPageCacheResponsePolicyService($lazyLoad = true)
    {
        ...
        $instance->addPolicy($this->get('node.page_cache_response_policy.deny_node_preview'));
        $instance->addPolicy($this->get('image.page_cache_response_policy.deny_private_image_style_download'));
    ...
    {
        $this->services['route_enhancer.lazy_collector'] = $instance = new \Drupal\Core\Routing\LazyRouteEnhancer(array('route_enhancer.param_conversion' => 'route_enhancer.param_conversion', 'route_enhancer.authentication' => 'route_enhancer.authentication', 'route_enhancer.entity' => 'route_enhancer.entity', 'field_ui.route_enhancer' => 'field_ui.route_enhancer'));
    ...
    {
        $this->services['router.builder'] = $instance = new \Drupal\Core\Routing\RouteBuilder($this->get('router.dumper'), $this->get('lock'), $this->get('event_dispatcher'), $this->get('module_handler'), $this->get('controller_resolver'), $this->get('access_manager.check_provider'));
    ...
    /**
     * Gets the 'test_discovery' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\simpletest\TestDiscovery A Drupal\simpletest\TestDiscovery instance.
     */
    protected function getTestDiscoveryService()
    {
        $this->services['test_discovery'] = $instance = new \Drupal\simpletest\TestDiscovery($this->get('class_loader'), $this->get('cache.discovery', ContainerInterface::NULL_ON_INVALID_REFERENCE));

        $instance->_serviceId = 'test_discovery';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'simpletest' => array(
                    'type' => 'module',
                    'pathname' => 'core/modules/simpletest/simpletest.info.yml',
                    'filename' => 'simpletest.module',
                ),
                'system' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\simpletest' => 'core/modules/simpletest/src',
